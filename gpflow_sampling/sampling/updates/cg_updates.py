...
def _cg_independent(
    kern: kernels.MultioutputKernel,
    Z: TensorLike,
    u: TensorLike,
    f: TensorLike,
    *,
...
def _cg_shared(kern, Z, u, f, *, multioutput_axis=None, **kwargs):
    ...
    """
    return _cg_independent(kern, Z, u, f, multioutput_axis=multioutput_axis, **kwargs)
...
def _cg_conv2d(kern, Z, u, f, *, basis=None, multioutput_axis=None, **kwargs):
    ...
    return _cg_independent(
        kern, Z, u, f, basis=basis, multioutput_axis=multioutput_axis, **kwargs
    )
