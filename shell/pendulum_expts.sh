python run.py -m name=rollout_pendulum alg=rollout_bac num_iters=200 eval_frequency=5 env=pendulum seed="range(5)" hydra/launcher=joblib
...
# python run.py -m name=random_pendulum alg=random num_iters=200 eval_frequency=5 env=pendulum seed="range(5)" hydra/launcher=joblib
