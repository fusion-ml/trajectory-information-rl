python run.py -m name=open_loop_bac_short_lava alg=open_loop_barl num_iters=200 eval_frequency=20 env=short_lava_path eigmpc.num_iters=6 test_mpc.num_iters=6 seed="range(5)" hydra/launcher=joblib
