...
python run.py -m name=sum_barl_reacher alg=sum_barl num_iters=1500 eval_frequency=50 env=reacher seed="range(5)" hydra/launcher=joblib
python run.py -m name=sus_reacher alg=sus num_iters=1500 eval_frequency=50 env=reacher seed="range(5)" hydra/launcher=joblib
python run.py -m name=rus_barl_reacher alg=rus num_iters=1500 eval_frequency=50 env=reacher seed="range(5)" hydra/launcher=joblib
